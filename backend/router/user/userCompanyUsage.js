...
router.get('/getData/all/:page/:sortField/:sortType', function(req,res){
  ...
  let sql = `SELECT a.corp_name, b.memberSearchCounting, c.totalSearchCounting, d.nonMemberSearchCounting, e.watchCounting, f.memoCounting FROM CompanyInfo as a
