...
export default function AccumulReportsManagement({
  searchInput,
  searchCompanyCode,
  searchRefreshSwitch,
}) {
  ...
  scrollRightUseEffect(financialData, 3);

  useEffect(() => {
    if (searchCompanyCode !== '') {
      const body = { ...searchInput, corp_code: searchCompanyCode };
      axios
        .get(`${url}/admin/company/financial/management/getData/search/accumulteReports/s3`, {
          params: body,
        })
        .then(result => {
...
AccumulReportsManagement.defaultProps = {
  searchInput: {},
  searchCompanyCode: '0',
  searchRefreshSwitch: true,
};

AccumulReportsManagement.propTypes = {
